  ...
  render() {
    return (
      <div>
        ...
        <br />
        <br />
        <font size="7" style={{ margin: '5%' }}>Enter Your credit card info and have me any way you want baby!</font>
        <br />
        <br />
        <div className="row">
        ...
        <span className="price" style={{ color: 'black' }}>
              ...
              <p><a href="#">Handy</a> <span className="price">$15</span></p>
              <p><a href="#">Blowy</a> <span className="price">$25</span></p>
              <p><a href="#">Cuddle</a> <span className="price">$15/hr</span></p>
              <p><a href="#">Family <br />event</a> <span className="price">$35/hr</span></p>
              <hr />
              <p>Total <span className="price" style={{ color: 'black' }}><b>$$$</b></span></p>
            </div>
          </div>
        </div>
